...
In conclusion, the total precipitation in 2018 is 70.33, and the median number of sports balls in a dumpster in 2019 is 9. We omit some non-data columns and rows to clean the Trash Wheel data set. For example, we round the variable of "number of sports balls" to integer. For the 2018 and 2019 Precipitation combined data set, I suppose that the key variable is "total", since it illustrates the monthly precipitation value for both 2018 and 2019.
